...
function news() {
	this.linke.innerHTML = "<a href='https://github.com/AvixSoft/vid17mod' target='_blank'>Vid17 Mods";
    cityWorker.postMessage({tell:"NEWS"});
}
...
V3D.Base = function(isMobile, pix, isLow){
	...
	this.snd_layzone = new Audio("./sound/layzone.wav");
...
HUB.Base.prototype = {
    ...
    intro:function(){
        ...
        this.subtitle.innerHTML = "Building HTML5 Engine";
    ...
    initStartHub : function(){
        ...
        this.hub.appendChild( this.full );
        var b1 = this.addButton(this.full, 'Start Map', [276,48,40], 'position:absolute; top:10px; left:0px;');
    	var b2 = this.addButton(this.full, 'Refresh',  [120, 26, 22], 'position:absolute; top:150px; left:0px;');
        var b3 = this.addButton(this.full, 'Terraform',  [120, 26, 22], 'position:absolute; top:150px; right:0px;');
        var b4 = this.addButton(this.full, 'Load Map',  [276, 26, 22], 'position:absolute; top:90px; left:0px;');
		 var b5 = this.addButton(this.full, 'News',  [276, 26, 22], 'position:absolute; top:270px; left:0px;');
		 var b6 = this.addButton(this.full, 'Building Editor',  [276, 26, 22], 'position:absolute; top:390px; left:0px;');
		 var b6 = this.addButton(this.full, 'Mods',  [276, 26, 22], 'position:absolute; top:330px; left:0px;');
        this.addSelector("DIFFICULTY", ['Mayor', 'Planner', 'Governor'], setDifficulty, 0);
		...
		b5.addEventListener('click',  function ( e ) { e.preventDefault(); news(true); }, false);
    },
    ...
    initGameHub : function(){
        ...
        var b2 = this.addButton(this.hub, 'Status', [75,16,14], 'position:absolute; left:110px; top:-7px; font-weight:bold;', true);
        ...
        var b4 = this.addButton(this.hub, 'Options', [75,16,14], 'position:absolute; left:310px; top:-7px; font-weight:bold;', true);
    ...
    openAbout : function(data){
        ...
        if(this.aboutWindow == null){
            ...
            this.abb.innerHTML = "VidCity 17<br><br>Built with the 3d.city Engine<br>by Nikolas Karinja at NK Studios<br><br><br>Mods available at<br>";
            this.linke.innerHTML = "<a href='https://github.com/AvixSoft/vid17mod' target='_blank'>Vid17 Mods";
    ...
    openExit : function(data){
        ...
        if(this.exitWindow == null){
            ...
            var bg1 = this.addButton(this.exitWindow, 'X', [16,16,14], 'position:absolute; left:10px; top:10px;');
            var bg2 = this.addButton(this.exitWindow, 'Refresh', [96,16,14], 'position:absolute; left:10px; top:50px;');
            var bg3 = this.addButton(this.exitWindow, 'Save Map', [96,16,14], 'position:absolute; left:10px; top:90px;');
            var bg4 = this.addButton(this.exitWindow, 'Load Map', [96,16,14], 'position:absolute; left:10px; top:130px;');
